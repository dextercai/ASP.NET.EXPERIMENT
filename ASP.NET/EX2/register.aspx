<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="EX2_register" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:RequiredFieldValidator runat="server" ID="rfvName" ControlToValidate="txtName" Display="Dynamic" SetFocusOnError="True" ErrorMessage="请输入用户名" Text="*"></asp:RequiredFieldValidator>
            <br/>
